                ...
                <div className="page-container">
                    <div className="exercise-container animate-fade-in">
                        <div className="exercise-header">
                            <h2 style={{ textAlign: 'center', color: 'var(--primary-light)' }}>✍️ {currentLesson.title}: Writing Basics</h2>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '2rem' }}>
                            ...
                            <button className="btn btn-primary" onClick={() => {
                                ...
                                {currentTutorialIndex < tutorial.length - 1 ? 'Next →' : 'Start Writing!'}
                            </button>
                        </div>
                    </div>
                </div>
                                    ...
                                    {(lessonType === 'type_word' || lessonType === 'fill_letters') && (
                                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '10px' }}>
                                            <button
                                                ...
                                                onClick={() => speakText(getExpected(), currentLesson.language_code)}
                                                title="Listen"
